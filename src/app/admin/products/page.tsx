          ...
          <div className="flex-1 p-8">
            <div className="bg-card rounded-lg shadow">
              <div className="p-8 text-center">
                ...
                <h3 className="mt-4 text-lg font-medium text-foreground">No category selected</h3>
          ...
          {/* Category Header */}
            <div className="bg-card mb-6">
              ...
              <div className="relative">
                ...
                <span className="absolute top-0 right-0 bg-blue-100 text-blue-800 text-sm px-3 py-1 rounded-full">
                        ...
                        <div className="p-4">
                          ...
                          {product.attributes.price ? (
                            ...
                            product.attributes.price_from === product.attributes.price_to ? (
                              ...
                              <p className="text-sm text-muted-foreground mb-2">Price not available</p>
                          )}
