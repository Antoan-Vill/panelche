      ...
      <div className="w-full h-dvh flex items-center justify-center bg-background">
        <div className="w-full max-w-md p-8 bg-card rounded-lg shadow-md border border-border">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            >
              {isSubmitting ? t('auth.pleaseWait') : (isSignUp ? t('auth.signUp') : t('auth.signIn'))}
            </button>
          </form>
          ...
          <div className="mt-6">
            ...
            <button
              ...
              className="mt-4 w-full px-4 py-2 border border-border rounded-md hover:bg-muted flex items-center justify-center gap-2"
            >
